...
/** Utility functions used by the GlobalgameCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GGC addresses in monospace font
...
// Parse "globalgamecoin:" URI into recipient object, return true on successful parsing
