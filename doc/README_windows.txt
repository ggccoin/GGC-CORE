Globalgame Coin Core
=====================

Intro
-----
Globalgame Coin (GGC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Globalgame Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run globalgamecoin-qt.exe.

Globalgame Coin Core is the original Globalgame Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Globalgame Coin transactions;
