...
#   c) node1 mines 32 blocks, so now node 0 has 500000GGC, node 1 has 4250GGC, node2 has none.
#   d) node0 sends 601 GGC to node2, in two transactions (301 GGC, then 300 GGC).
