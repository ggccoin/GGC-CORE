...
This mechanism has been integrated into Bitcore-Node-GlobalgameCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/globalgamecoin/insight-api-globalgamecoin#web-socket-api](https://github.com/globalgamecoin/insight-api-globalgamecoin#web-socket-api)
* API: [https://github.com/globalgamecoin/insight-api-globalgamecoin#swifttx-transactions](https://github.com/globalgamecoin/insight-api-globalgamecoin#swifttx-transactions)
...
By default, the Globalgame Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Globalgame Coin Core daemon:
