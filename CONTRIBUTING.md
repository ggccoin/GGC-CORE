Contributing to Globalgame Coin Core
==================================

The Globalgame Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Globalgame Coin Core project, and is not to be
confused with overall Globalgame Coin Network Protocol consensus changes.

Whether a pull request is merged into Globalgame Coin Core rests with the project merge
...
Patches that change Globalgame Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Globalgame Coin consensus, it must have been
...
The project leader is the release manager for each Globalgame Coin Core release.
