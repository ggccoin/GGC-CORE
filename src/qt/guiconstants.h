...
/* Globalgame Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GlobalgameCoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "GlobalgameCoin-Qt"
#define QAPP_APP_NAME_TESTNET "GlobalgameCoin-Qt-testnet"
