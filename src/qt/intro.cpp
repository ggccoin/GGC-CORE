...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Globalgame Coin Core"),
     ...
     * override -datadir in the globalgamecoin.conf file in the default data directory
     * (to be consistent with globalgamecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
