...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Globalgame Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Globalgame Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Globalgame Coin features */
        {"globalgamecoin", "masternode", &masternode, true, true, false},
        {"globalgamecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"globalgamecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"globalgamecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"globalgamecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"globalgamecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"globalgamecoin", "startmasternode", &startmasternode, true, true, false},
        {"globalgamecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"globalgamecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"globalgamecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"globalgamecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"globalgamecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"globalgamecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"globalgamecoin", "mnbudget", &mnbudget, true, true, false},
        {"globalgamecoin", "preparebudget", &preparebudget, true, true, false},
        {"globalgamecoin", "submitbudget", &submitbudget, true, true, false},
        {"globalgamecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"globalgamecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"globalgamecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"globalgamecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"globalgamecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"globalgamecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"globalgamecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"globalgamecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"globalgamecoin", "mnsync", &mnsync, true, true, false},
        {"globalgamecoin", "spork", &spork, true, true, false},
        {"globalgamecoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"globalgamecoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"globalgamecoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"globalgamecoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"globalgamecoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"globalgamecoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> globalgamecoin-cli " + methodname + " " + args + "\n";
}
