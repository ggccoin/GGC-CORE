...
In order to support loading of multiple wallets in globalgamecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is globalgamecoin.cpp.
...
Changes to globalgamecoin.cpp
----------------------
globalgamecoin.cpp is the entry point into globalgamecoin-qt, and as such, will require some minor modifications to provide hooks for
