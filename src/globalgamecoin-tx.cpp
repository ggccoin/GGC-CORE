...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Globalgame Coin Core globalgamecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  globalgamecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globalgame coin transaction") + "\n" +
                               "  globalgamecoin-tx [options] -create [commands]   " + _("Create hex-encoded globalgame coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded globalgame coin transaction
